...
export class nrrd_tools {
  ...
  setSliceOritention(slices: Array<any>) {
    /**
     * before you use this function, you might need to know how many contrast images you have.
     * Then you need to put the same number of contrast images into this array parameter.
     * */
    this.slice = slices[0];
    this.axis = this.slice.axis;
    this.originCanvas = this.slice.canvas;
